...
{$ELSE}
{$ENDIF}
  UFolderHelper, UConst, UNode, UPascalCoinSafeBox;
...
begin
  ...
  lblProtocolVersion.Caption := Format('BlockChain Protocol: %d (%d)  -  Net Protocol: %d (%d)',[PascalCoinSafeBox.CurrentProtocol,CT_BlockChain_Protocol_Available,
